...
$jscomp.registerAndLoadModule(function($$require, $$exports, $$module) {
  ...
  function Browser(jq) {
    this.vueContainer = new module$src$vue_container["default"]({appContainer:"#browser-app", jq:jq});
    window.vueContainer = this.vueContainer;
  }
}, "src/browser.js", ["src/vue-container.js"]);

//./src/script.js
$jscomp.registerAndLoadModule(function($$require, $$exports, $$module) {
  "use strict";
  var module$src$browser = $$require("src/browser.js");
  $(function() {
    window.browser = new module$src$browser["default"]($);
  });
}, "src/script.js", ["src/browser.js"]);
...
$jscomp.registerAndLoadModule(function($$require, $$exports, $$module) {
  ...
  function VueContainer(options) {
    var config = {el:options.appContainer, data:{loreDefinition:{list:[], selected:{name:"", description:"", subtitle:""}}, recordDefinition:{list:[]}, collectibleDefinition:{list:[], selected:{name:"", description:"", iconPath:""}}}, methods:{}};
    var jq = options.jq;
    var fetchJson = function(filePath) {
      return jq.ajax({type:"GET", dataType:"json", url:filePath + ".json", error:function(xhr, textStatus, errorThrown) {
    ...
    config.methods.listItemClicked = function(definition, e) {
      ...
      var group = $(e.target).closest("div.datalist").data("source");
    ...
    config.data.loreDefinition.display = function(details) {
      ...
      config.data.loreDefinition.selected.description = details.displayProperties.description;
    ...
    config.data.collectibleDefinition.display = function(details) {
      ...
      config.data.collectibleDefinition.selected.description = details.displayProperties.description;
      config.data.collectibleDefinition.selected.iconPath = details.displayProperties.hasIcon ? getImagePath(details.displayProperties.icon) : "";
    };
    this.config = config;
